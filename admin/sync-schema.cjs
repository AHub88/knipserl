...
async function syncSchema() {
  ...
  const columns = [
    ...
    ["orders", "onSiteContactName", "TEXT", true, null],
    ["orders", "onSiteContactPhone", "TEXT", true, null],
    ["orders", "onSiteContactNotes", "TEXT", true, null],
    ["orders", "extraPaperRolls", "INTEGER", false, "0"],
