  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <Link
          href="/inquiries/new"
          className="flex items-center gap-2 h-9 px-3 sm:px-4 rounded-lg bg-primary text-black text-sm font-semibold hover:bg-primary/90 transition-colors"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
        <div className="flex items-center gap-3 rounded-xl border border-border bg-card px-3 py-3">
          ...
          <div>
            <p className="text-xl font-bold text-foreground">{countByStatus.total}</p>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-border bg-card px-3 py-3">
          ...
          <div>
            <p className="text-xl font-bold text-foreground">{countByStatus.new}</p>
            <p className="text-[11px] text-muted-foreground">Neu</p>
          </div>
        </div>
        <div className="flex items-center gap-3 rounded-xl border border-border bg-card px-3 py-3">
          ...
          <div>
            <p className="text-xl font-bold text-foreground">{countByStatus.accepted}</p>
        ...
        <div className="flex items-center gap-3 rounded-xl border border-border bg-card px-3 py-3">
          ...
          <div>
            <p className="text-xl font-bold text-foreground">{countByStatus.rejected}</p>
      ...
      {inquiries.length === 0 ? (
        <div className="rounded-xl border border-border bg-card flex flex-col items-center justify-center py-16 text-muted-foreground">
          <IconInbox className="size-10 mb-3 text-muted-foreground" />
