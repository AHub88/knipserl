          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                disabled={!isPrivateLocation && locationAddress !== ""}
              />
            </div>
            <div>
              ...
              <input
                ...
                disabled={!isPrivateLocation && distanceKm !== ""}
                placeholder="–"
              />
            </div>
          </div>
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 space-y-4">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div>
              ...
              <input className={inputClass + " font-semibold text-[#F6A11C]"} type="number" step="0.01" value={price} onChange={(e) => setPrice(e.target.value)} placeholder="0.00" />
            </div>
          </div>
        </div>
