...
export default async function FotoboxWeihnachtsfeierPage() {
  ...
  return (
    <>
      ...
      {/* IMPRESSIONS — wird im Admin unter /pages/fotobox-fuer-weihnachtsfeier gepflegt */}
      <ImpressionSection
        pageSlug="fotobox-fuer-weihnachtsfeier"
        title="Weihnachtsfeier-Impressionen"
        subtitle="Unsere Fotobox auf Weihnachtsfeiern"
      />
      ...
      <CityCrossLinks occasionLabel="Weihnachtsfeier" />
