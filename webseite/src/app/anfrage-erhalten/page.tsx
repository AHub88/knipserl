        ...
        <div className="max-w-[760px] mx-auto px-6">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center items-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 px-7 py-3 bg-[#25D366] hover:bg-[#1fb955] transition-colors rounded-md text-white text-[22px] uppercase tracking-[0.08em] font-extrabold font-[family-name:var(--font-fira-condensed)] shadow-[0_4px_16px_rgba(37,211,102,0.25)]"
            >
